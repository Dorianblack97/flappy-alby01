...
(function () {
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const html_new_score_text = document.getElementById('overlay-new-score-text');
        const html_new_score_button = document.getElementById('overlay-new-score-button');
        ...
        const overlayService = new OverlayService(html_overlay, html_overlay_title, html_overlay_score, html_start_button, html_new_score_text, html_new_score_button);
        const levelService = new LevelService(html_level, levelsOptions);
        const livesService = new LivesService(html_lives, 1);
        ...
        html_new_score_button.onclick = () => rankingService.sendScore(game.Stopwatch);
    });
})();